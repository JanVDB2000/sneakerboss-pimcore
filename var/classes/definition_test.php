 ...
 * Fields Summary:
 * - username [input]
 * - usernameCanonical [input]
 * - email [input]
 * - emailCanonical [input]
 * - name [input]
 * - password [password]
 * - enabled [checkbox]
 * - userRoles [manyToManyObjectRelation]
 * - idUser [input]
 * - salt [input]
 * - lastLogin [datetime]
 */
        ...
        array (
          ...
          Pimcore\Model\DataObject\ClassDefinition\Layout\Panel::__set_state(array(
            ...
            array (
             ...
             'layout' => '',
             'border' => true,
             'icon' => '/bundles/pimcoreadmin/img/flat-color-icons/bar_chart.svg',
             'labelWidth' => 0,
             'labelAlign' => 'left',
          )),
        ),
